...
savenii_imag(gdat,outfilename_imag,res);

outfilename_real = strcat(outfolder,'/','re_',strrep(file,'.dat',''),'_filter_',filter,'_echo_',num2str(echo),'.nii');
savenii_real(gdat,outfilename_real,res);
